...
class Producto extends Model
{
    ...
    protected $casts = [
        'id_cta_vta'      => 'int',         'id_cta_inv'      => 'int',       'id_tp_prd'       => 'int',
        'id_cls_dane_prd' => 'int',         'id_med_cpra'     => 'int',         'densidad'      => 'float',
        'mp_prda'         => 'bool',        'mp_ctrlda'       => 'bool',       'prestable'       => 'bool',
        'accesorio'       => 'bool',      'inactivo'        => 'bool'
          ];

    protected $fillable = [
              'clave',                    'id_cta_vta',                     'id_cta_inv',                   'id_tp_prd',
              'id_cls_dane_prd',          'id_med_cpra',                    'nom_prd',                      'nom_faction',
              'fragancia',                'tp_dspcho',                      'densidad',                     'mp_prda',
              'mp_ctrlda',                'prestable',                      'accesorio',                    'inactivo'
        ];
   ...
   /*//////////////////////////////////////
        SCOPES
   *//////////////////////////////////////
    public function scopeNomPrdContiene($query, $Filtro){
        return $query->where('nom_prd','like', '%'.$Filtro .'%');
    }
